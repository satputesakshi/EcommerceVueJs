...
export const store = new Vuex.Store({
    state: {
        topRated: [{ id: 1, name: 'Nike Trainers', price: 50, url: shoe1, desc: "The Perfect Trainers", rate: 4.1 }, { id: 2, name: 'Low Jordans', price: 120, url: blueshoe, desc: 'Show Your AJ1 Appeal', rate: 4.1 }, { id: 3, name: 'Mesh Trainers', price: 200, url: whiteshoe, desc: "Lightweight & Sturdy", rate: 4.2 }],

        allCategories: [{ id: 4, name: 'Nike Mids', price: 80, url: nike, desc: "Classic Kicks from '72", rate: 4.5 }, { id: 5, name: 'Nike Jordan 1 Low', price: 130, url: jordan, desc: "The Iconic Jordan 1'S", rate: 4.0 }, { id: 6, name: 'VANS', price: 60, url: darkyellow, desc: "Especially for Skaters", rate: 4.2 }],
